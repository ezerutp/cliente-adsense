...
| [Configuración y ubicaciones](settings-locations.md) | Personalización y catálogo geográfico |
| [Auth y permisos](auth-permissions.md) | Acceso, roles y autorización |

Los módulos administrativos requieren usuario autenticado, correo verificado y rol `admin`, salvo el perfil que solo requiere autenticación.
